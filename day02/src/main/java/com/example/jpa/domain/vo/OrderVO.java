...
//     만약 연관관계의 주인이 아니라면 해당 객체에서는 mappedBy 속성을 사용하여 본인의 주인을 지정해주어야 한다.

//    2. 다중성
//     다대일(N:1)
//     한 개의 상품(1)은 여러 번 주문(N)할 수 있다.
//     한 번의 주문 당 한 개의 상품만 가질 수 있다.
